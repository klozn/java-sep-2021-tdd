...
class CustomerTest {
    ...
    void statementForRegularMovie() {
        ...
        Customer customer2 =
                customer()
                        ...
                        .withRentals(rental1)
                        .build();
        String expected = String.format("Rental Record for Sallie%n" +
                "\tGone with the Wind\t3.5%n" +
    ...
    void statementForManyMovies() {
        ...
        Customer customer1
                ...
                .build();
        String expected = String.format("Rental Record for David%n" +
                "\tMadagascar\t6.0%n" +
                "\tStar Wars\t6.0%n" +
                "\tGone with the Wind\t11.0%n" +
